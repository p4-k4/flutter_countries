...
const _jsonPathCities = '../src/assets/cities.json';
const _jsonPathStates = '../src/assets/states.json';
const _jsonPathCountries = '../src/assets/countries.json';
...
class Countries {
  static Future<List<Country>> get all async => await getCountries();
  ...
  static Future<List<Country>> byCapital(String capital) async =>
      _query<Country>(await getCountries(),
...
class Cities {
  ...
  static Future<List<City>> get all async => await getCities();
...
class States {
  ...
  static Future<List<State>> get all async => await getStates();
